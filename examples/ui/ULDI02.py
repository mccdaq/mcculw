...
Library Call Demonstrated:  mcculw.ul.d_bit_in()

Purpose:                    Reads the status of single digital input bits.

Demonstration:              Configures the first compatible port for input (if
                            necessary) and then reads and displays the bit
                            values.

Other Library Calls:        mcculw.ul.d_config_port()

Special Requirements:       Device must have a digital input port or have
                            digital ports programmable as input.
"""
